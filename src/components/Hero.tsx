...
const AnimatedIcon = memo(({ children, delay = 0 }: { children: React.ReactNode; delay?: number }) => (
  <motion.div 
...
// Memoized JavaScript SVG
const JavaScriptIcon = memo(() => (
...
// Memoized central glow animation
const CentralGlow = memo(() => (
  <motion.div 
...
CentralGlow.displayName = "CentralGlow";
